...
public final class Main {
   ...
   public static void main(String[] args) {
      ...
      if (!(p1.add(v1Opposite).equals(Double3.ZERO)))
      ...
      // Test primitives.Vector operations ===============================================
      ...
      try {
         v1.add(v1Opposite);
         out.println("ERROR: primitives.Vector + -itself does not throw an exception");
      } catch (IllegalArgumentException ignore) {} catch (Exception ignore) {
         out.println("ERROR: primitives.Vector + itself throws wrong exception");
      }
      try {
         v1.subtract(v1);
         out.println("ERROR: primitives.Vector - itself does not throw an exception");
      ...
      if (!v1.add(v2).equals(v1Opposite))
         out.println("ERROR: primitives.Vector + primitives.Vector does not work correctly");
